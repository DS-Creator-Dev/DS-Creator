...
var SoundbankHText: string;
var SoundbankBinHText: string;
var SoundbankBinText: string;
var SoundbankBinOText: string;
...
(() => {
    ...
    document.querySelector('#blank-proj-btn')?.addEventListener('click', () => {
	  ...
	  localStorage.setItem("EventText", EventsText)
      api.MakeBlankProject(ProName, ProPath, MakefileText, MainCText, SoundbankBinHText, SoundbankHText);
    })
})()